...
function(
    ...
    return SplunkVisualizationBase.extend({
        ...
        defaultConfig: {
            ...
            'display.visualizations.custom.leaflet_maps_app.leaflet_maps.showHeatLine' : 0,
            'display.visualizations.custom.leaflet_maps_app.leaflet_maps.heatLineIdentifier' : "",
            'display.visualizations.custom.leaflet_maps_app.leaflet_maps.heatLineMaxValue' : 100,
            'display.visualizations.custom.leaflet_maps_app.leaflet_maps.heatLineMinValue' : 0,
            'display.visualizations.custom.leaflet_maps_app.leaflet_maps.heatLineMaxColor' : "#FF0000",
            'display.visualizations.custom.leaflet_maps_app.leaflet_maps.heatLineMedColor' : "#FFFF00",
            'display.visualizations.custom.leaflet_maps_app.leaflet_maps.heatLineMinColor' : "#008800",
            'display.visualizations.custom.leaflet_maps_app.leaflet_maps.heatLineBorderWidth' : 1,
            'display.visualizations.custom.leaflet_maps_app.leaflet_maps.heatLineBorderColor' : "#000000",
            'display.visualizations.custom.leaflet_maps_app.leaflet_maps.heatLineWeight' : 5
        },
        ATTRIBUTIONS: {
